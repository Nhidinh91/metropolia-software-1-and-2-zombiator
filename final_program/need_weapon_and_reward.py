...
# This function returns a dictionary with the country as key and the list of difficult level, min amount, max amount and passing condition as value
def need_weapon_and_reward():
    ...
    for country in list_country:
        if count == 5 and "hard" in difficult:
